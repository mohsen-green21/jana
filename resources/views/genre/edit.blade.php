        ...
        <div class="col-lg-12">
            <div class="d-flex ">
                ...
                <div style="flex: 1" class="">
                    ...
                    <form action="{{url('genre/'.$genre->_id)}}" enctype="multipart/form-data" id="form_genre1"
                        method="POST">
                            ...
                            <div class="d-flex flex-column ">
                                <div class="form-group mb-3 mr-2">
                                    ...
                                    <input class="form-control" id="product-name" name="name" placeholder="" type="text"
                                        value="{{ old('name') != null ? old('name') : $genre->name   }}">
                                ...
                                <div class="mr-2">
                                    ...
                                    <input class="form-control " name="slug" type="text"
                                        value="{{ old('slug') != null ? old('slug') :  $genre->slug }}" />
