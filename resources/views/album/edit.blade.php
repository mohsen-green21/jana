                    ...
                    <form action="{{url('album/'.$albumsedite->_id)}}" enctype="multipart/form-data" method="post">
                        ...
                        <div class="d-flex flex-column mt-4">
                            <div class="form-group m-3 " style="">
                                ...
                                <input class="form-control border-top-0 border-right-0 border-left-0" id="product-name" name="name" placeholder="" type="text"
                                    value="{{old('name') != null ? old('name') : $albumsedite->name }}">
