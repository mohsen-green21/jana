                ...
                <form action="{{url('artist/'.$artists->_id)}}" enctype="multipart/form-data" method="post" multiple="">
                   ...
                   <input name="artist_id" value="{{ isset($artists->_id) ? $artists->_id : ''}}" type="hidden">
                    <div class="d-flex flex-column flex-md-row">
                        <div class="form-group mb-3 mr-0 mr-lg-3" style="flex: 1">
                            ...
                            <input class="form-control border-top-0 border-left-0 border-right-0" id="product-name" name="name" placeholder="" type="text" value="{{ old('name') != null ? old('name') : $artists->name  }}">
                            </input>
                        </div>
                  ...
                  <span class="text-danger">
                    *
                            ...
                            <input class="form-control mt-3 border-top-0 border-left-0 border-right-0" name="des" placeholder=""  value="{{ old('des') != null ? old('des') : $artists->bio  }}"/>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
