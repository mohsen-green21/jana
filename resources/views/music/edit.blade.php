                    ...
                    <div class="card-box">
                        ...
                        <div class="d-flex flex-column flex-md-row">
                            <div class="form-group mb-3 mr-0 mr-md-3 " style="flex:1">
                                ...
                                <input class="form-control border-top-0 border-right-0 border-left-0" id="product-name" name="name" placeholder="" type="text" value="{{old('name') != null ? old('name') : $music->name}}">
                                </input>
                            </div>
...
{{-- fild4 --}}
                        <div class="d-flex flex-column flex-md-row">
                            <div class="form-group mb-3 mr-0 flex-md-3 " style="flex:1">
                                <label>
